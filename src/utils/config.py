def getConfigs():
    ...
    API_Key = "PLACE KEY HERE" #PLACE YOUR API KEY IN QUOTES HERE EX.  API_Key = "DEMOAPI69420"
    paid =  True or False#This controls which AlphaVantage API call is used. ADJ monthly close price id True. Monthly close price if false.
